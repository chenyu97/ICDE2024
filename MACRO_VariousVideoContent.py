...
if flag_first:
    ...
    with open('./dataset_VariousVideoContent/Fn_parameter.csv', 'w', newline='') as csvfile:
    ...
    with open('./dataset_VariousVideoContent/re_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/accuracy_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/G_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/b_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/BB_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerows(rows_B_parameter)
    # gamma_d
    ...
    with open('./dataset_VariousVideoContent/gamma_d_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/gamma_c_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/omega_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/c_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset_VariousVideoContent/CC_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerows(rows_C_parameter)
else:
    # Fn:
    data = []
    with open('./dataset_VariousVideoContent/Fn_parameter.csv', 'r') as csvfile:
    ...
    # re:
    data = []
    with open('./dataset_VariousVideoContent/re_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for j in range(M):
    ...
    for i in range(N):
        for j in range(M):
            a_re_array[i, j] = a_11 + (a_12 - a_11) * 0.3
            b_re_array[i, j] = b_11 + (b_12 - b_11) * 0.3
            c_re_array[i, j] = c_11 + (c_12 - c_11) * 0.3
            a_fr_array[i, j] = a_21 + (a_22 - a_21) * ratio
            b_fr_array[i, j] = b_21 + (b_22 - b_21) * ratio
            c_fr_array[i, j] = c_21 + (c_22 - c_21) * ratio
    # Profit Gn:
    data = []
    with open('./dataset_VariousVideoContent/G_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for i in range(N):
    ...
    # b_n,m:
    data = []
    with open('./dataset_VariousVideoContent/b_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for i in range(N):
    ...
    # B:
    data = []
    with open('./dataset_VariousVideoContent/BB_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for i in range(N):
    ...
    # gamma_d:
    data = []
    with open('./dataset_VariousVideoContent/gamma_d_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for j in range(M):
    ...
    # gamma_c
    data = []
    with open('./dataset_VariousVideoContent/gamma_c_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for i in range(N):
    ...
    # omega:
    data = []
    with open('./dataset_VariousVideoContent/omega_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for j in range(M):
    ...
    # c_n,m:
    data = []
    with open('./dataset_VariousVideoContent/c_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for i in range(N):
    ...
    # C:
    data = []
    with open('./dataset_VariousVideoContent/CC_parameter.csv', 'r') as csvfile:
        csvreader = csv.reader(csvfile)
        for row in csvreader:
            data.append([float(value) for value in row])
    for j in range(M):
...
def callback_function(xk):
    ...
    with open('./result_VariousVideoContent/incentive.csv', 'a', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
...
def write_random_initial(xk):
    ...
    for i in range(N):
        for j in range(M):
            row_incentive.append((gamma_d_array[j] * re_array[j] * re_array[j] + gamma_c_array[i][j]) * omega_array[j] * xk[i * M + j])
    rows_incentive.append(row_incentive)
    with open('./result_VariousVideoContent/incentive.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerows(rows_incentive)
