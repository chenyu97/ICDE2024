...
if flag_first:
    ...
    with open('./dataset/Fn_parameter.csv', 'w', newline='') as csvfile:
    ...
    with open('./dataset/re_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/accuracy_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/G_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/b_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/BB_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerows(rows_B_parameter)
    # gamma_d
    ...
    with open('./dataset/gamma_d_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/gamma_c_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/omega_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/c_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
    ...
    with open('./dataset/CC_parameter.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerows(rows_C_parameter)
else:
    # Fn:
...
def callback_function(xk):
    ...
    with open('./result/incentive.csv', 'a', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
...
def write_random_initial(xk):
    ...
    for i in range(N):
        for j in range(M):
            row_incentive.append((gamma_d_array[j] * re_array[j] * re_array[j] + gamma_c_array[i][j]) * omega_array[j] * xk[i * M + j])
    rows_incentive.append(row_incentive)
    with open('./result/incentive.csv', 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerows(rows_incentive)
